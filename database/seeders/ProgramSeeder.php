...
class ProgramSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('programs')->insert([
            ...
            [
                'id' => 14,
                'name' => 'Distance Degree Oromifa',
                'language' => 'Afan Oromo',
                'code' => 'PR-14-25',
                'status' => 'Active',
                'duration' => 4,
                'description' => 'Distance Degree Oromifa',
                'user_id' => 2,
                'created_at' => '2025-04-11 07:21:25',
                'updated_at' => '2025-04-11 07:21:25',
            ],
            [
                'id' => 15,
                'name' => 'Distance Deploma Oromifa',
                'language' => 'Afan Oromo',
                'code' => 'PR-15-25',
                'status' => 'Active',
                'duration' => 4,
                'description' => 'Distance Deploma Oromifa',
                'user_id' => 2,
                'created_at' => '2025-04-11 07:21:25',
                'updated_at' => '2025-04-11 07:21:25',
            ],
            [
                'id' => 16,
                'name' => 'Masters of Art in Bible Al Studies (MABTS) in Amharic',
                'language' => 'Amharic',
                'code' => 'PR-16-25',
                'status' => 'Active',
                'duration' => 4,
                'description' => 'Masters of Art in Bible Al Studies (MABTS) in Amharic',
                'user_id' => 2,
                'created_at' => '2025-04-11 07:21:25',
                'updated_at' => '2025-04-11 07:21:25',
            ],
