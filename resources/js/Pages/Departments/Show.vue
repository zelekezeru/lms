...
<template>
    <AppLayout>
      <div class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        <h1 class="text-3xl sm:text-4xl font-bold mb-6 text-center text-gray-900 dark:text-gray-100">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 border border-gray-200 dark:border-gray-700">
          <div class="grid gap-4 sm:grid-cols-2">
            <!-- Department Code -->
            <div>
              <span class="block text-sm text-gray-500 dark:text-gray-400">Code</span>
            ...
            <!-- Department Program -->
            <div>
              <span class="block text-sm text-gray-500 dark:text-gray-400">Program</span>
              <span class="block text-lg font-medium text-gray-900 dark:text-gray-100">
          ...
          <div class="mt-8">
            ...
            <div class="overflow-x-auto">
              <table class="min-w-full table-auto border-collapse">
                ...
                <tbody>
                  <tr
                    v-for="mode in department.studyModes"
                    :key="mode.id"
                  ...
                  >
                    <tr v-if="createMode" class="bg-gray-50 dark:bg-gray-700">
                      <td class="px-4 py-2">
                        <select
