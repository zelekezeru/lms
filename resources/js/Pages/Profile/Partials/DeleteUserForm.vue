...
<template>
    <section
        class="space-y-8 max-w-xl mx-auto bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700"
    >
        <header class="flex items-center gap-4">
            <div
                class="flex-shrink-0 bg-red-100 dark:bg-red-900 rounded-full p-3"
            >
                <svg
                ...
                >
                    <path
                        ...
                        d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5-4h4a2 2 0 012 2v2H7V5a2 2 0 012-2h4zm-7 4h14"
                    ></path>
                </svg>
            </div>
            <div>
    ...
    <Modal :show="confirmingUserDeletion" @close="closeModal">
        <div
            class="p-8 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 mx-auto"
        >
