...
<template>
    <div :class="{ dark: darkMode }">
        <div class="flex h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 relative">
            ...
            <div v-if="isMobile && isSidebarOpen" class="fixed inset-0 bg-black bg-opacity-50 z-40" @click="toggleSidebar" />
                    ...
                    <div class="flex items-center gap-4 ml-auto">
                        <div class="relative">
                            ...
                            <ul
                                ...
                                class="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 border rounded-md shadow z-50"
                            >
                                <li class="p-4">
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <Link :href="route('profile.edit')" class="btn btn-sm mt-2 bg-gray-700 text-white rounded-md px-3 py-1 hover:bg-gray-600">
                                                View Profile
                                            </Link>
                                        </div>
                                    </div>
