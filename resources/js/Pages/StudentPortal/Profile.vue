<template>
    <AppLayout>
        <div class="p-6 space-y-6">
            <!-- Profile Header -->
            <div
                class="flex flex-col md:flex-row items-center md:items-start md:justify-between gap-6"
            >
                ...
                <a
                    class="bg-indigo-300 dark:bg-gray-800 text-gray-900 dark:text-white rounded-md p-2"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
                    ...
                    <div class="space-y-2 mt-2">
                        ...
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                            <span class="font-semibold">Office Phone:</span>
                            {{ student.officePhone }}
                        </p>
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                ...
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow">
                    ...
                    <div class="space-y-2 mt-2">
                        ...
                        <p class="text-sm text-gray-700 dark:text-gray-300">
                            <span class="font-semibold">Program language:</span>
                            {{ student.program.language }}
                        </p>
                        <p class="text-sm text-gray-700 dark:text-gray-300">
