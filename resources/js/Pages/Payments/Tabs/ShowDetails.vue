...
const filteredPayments = computed(() => {
    ...
    return (props.payments.data || []).filter(
        (payment) =>
            payment.status &&
            payment.status.toLowerCase() === selectedStatus.value
    );
});
</script>
...
<template>
    <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
            <!-- Total Payments -->
            <div
                class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow hover:shadow-lg transition duration-300"
            >
                            ...
                            {{
                                formatNumber(
                                    (payments.data || []).reduce(
                                        (sum, payment) =>
                                            sum + Number(payment.total_amount),
                                        0
                                    )
                                )
                            }}
        ...
        <div class="mb-6">
            ...
            <div
                class="mt-8 border-t border-b border-gray-300 dark:border-gray-600 pt-4 pb-4 overflow-x-auto"
            >
                <table
                ...
                >
                    <thead>
                        <tr class="bg-gray-50 dark:bg-gray-700">
                            <th
                                class="w-10 px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200 border-r"
                            >
                                No.
                            </th>
                            <th
                                class="w-40 px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200 border-r"
                            >
                                Paid By
                            </th>
                            <th
                            ...
                            <th
                                class="w-20 px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200 border-r"
                            >
                                Amount (Birr)
                            </th>
                            <th
                                class="w-40 px-4 py-2 text-center text-sm font-medium text-gray-700 dark:text-gray-200 border-r"
                            >
                                <div class="flex flex-col items-center">
                                    ...
                                    >
                                        <svg
                                            class="absolute left-3 w-4 h-4 text-blue-400 pointer-events-none"
                                            fill="none"
                                            stroke="currentColor"
                                            stroke-width="2"
                                            viewBox="0 0 24 24"
                                        ...
                                        >
                                            ...
                                            <option value="paid_by_college">
                                                Scholarship
                                            </option>
                                        </select>
                                        <svg
                                            class="absolute right-3 w-4 h-4 text-blue-400 pointer-events-none"
                                            fill="none"
                                            stroke="currentColor"
                                            stroke-width="2"
                                            viewBox="0 0 24 24"
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td
                                class="px-4 py-2 text-sm text-gray-600 dark:text-gray-300 border-r"
                            >
                                {{ formatNumber(payment.total_amount) }}.00
                            </td>
                            <td
                                class="px-4 py-2 text-sm text-gray-600 dark:text-gray-300 border-r"
                            >
