...
const createChart = () => {
  ...
  chart = new Chart(ctx, {
    type: 'line',
    data: {
      labels: ['Spring 2023', 'Summer 2023', 'Fall 2023', 'Spring 2024', 'Summer 2024'],
      datasets: [{
        label: 'GPA',
  ...
  <StudentLayout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      ...
      <div class="col-span-3 space-y-8">
        ...
        <!-- GPA Chart -->
        <section>
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Your GPA Results</h2>
        ...
        <section>
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Course Results</h2>
            ...
            <table class="min-w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr class="border-t border-gray-200 dark:border-gray-700">
                  <td class="py-4 px-6">Intro to Computer Science</td>
                ...
                <tr class="border-t border-gray-200 dark:border-gray-700">
                  <td class="py-4 px-6">Fundemintal Computer Science</td>
                  <td class="py-4 px-6">3</td>
                  <td class="py-4 px-6 font-semibold">A</td>
                  <td class="py-4 px-6">Dr. Jane Doe</td>
                </tr>
        ...
        <!-- Payment Information -->
        <section>
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Payment Information</h2>
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p class="mt-2 text-2xl font-bold text-green-500">$1,200.00</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md hover:shadow-lg transition">
              ...
              <p class="mt-2 text-2xl font-bold text-red-500">$300.00</p>
            </div>
            ...
            <table class="min-w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr class="border-t border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-900 transition">
                  ...
                  <td class="py-4 px-6 text-green-600 font-semibold">$2,000.00</td>
