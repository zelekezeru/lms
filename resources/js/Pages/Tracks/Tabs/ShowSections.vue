...
import { PlusCircleIcon, FolderOpenIcon } from "@heroicons/vue/24/outline";
...
const massRegisterStudents = (sectionId) => {
    Swal.fire({
        title: t("students.mass_register"),
        text: t("students.confirm_mass_register"),
        icon: "warning",
        ...
        if (result.isConfirmed) {
            useForm().post(route("sections.mass-register-students", { section: sectionId }), {
                onSuccess: () => {
                    Swal.fire(
                        t("students.success"),
                        t("students.mass_register_success"),
                        "success"
                    );
                },
                onError: () => {
            ...
            >
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td>
                            <PrimaryButton @click="massRegisterStudents(section.id)" class="ml-2">
                                <PlusCircleIcon class="w-5 h-5 mr-2" />
                                {{ $t("students.mass_register") }}
                            </PrimaryButton>
                        </td>
                        <td
                            class="w-40 px-4 py-2 text-sm text-gray-600 dark:text-gray-300 border-r border-gray-300 dark:border-gray-600"
                        >
                            ...
                            <Link
                                :href="
                                    route('trackCourses-section.assign', {
                                        section: section.id,
                                    })
                                "
                                class="inline-flex items-center px-3 py-1.5 bg-indigo-100 text-indigo-700 rounded-md shadow-sm hover:bg-indigo-200 transition-colors duration-200 ml-2"
                                title="Assign Courses"
                            >
                                <EyeIcon class="w-5 h-5 mr-1" />
                                <span class="font-medium">{{
                                    $t("sections.assign_courses")
                                }}</span>
                            </Link>
                        </td>
                    </tr>
