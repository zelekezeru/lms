                ...
                >
                    <thead>
                        <tr class="bg-gray-50 dark:bg-gray-700">
                            ...
                            <th
                                class="w-80 px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200 border-r"
                            >
                                Name
                            </th>
                            <th
                            ...
                            <th
                                class="w-60 px-4 py-2 text-left text-sm font-medium text-gray-700 dark:text-gray-200 border-r"
                            >
                                Track
                            </th>
                            <th
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td
                                class="px-4 py-2 text-sm text-gray-600 dark:text-gray-300 text-center"
                            >
                                <Link
                                    :href="
                                        route('students.show', {
