...
const courses = [
    {
        ...
        code: "CS101",
        enrolled: 90,
        calendar: "Mon & Wed - 10:00 AM",
        room: "Room 204",
        batches: [
            { id: 1, name: "CS101 - A", students: 45, time: "Mon - 10:00 AM" },
            { id: 2, name: "CS101 - B", students: 45, time: "Wed - 10:00 AM" },
        ],
    },
    {
        id: 2,
    ...
    },
    {
        ...
        code: "DB301",
        enrolled: 60,
        calendar: "Fri - 2:00 PM",
        room: "Lab 3",
        batches: [
            { id: 1, name: "DB301 - A", students: 30, time: "Fri - 2:00 PM" },
            { id: 2, name: "DB301 - B", students: 30, time: "Fri - 4:00 PM" },
        ],
    },
];
</script>
    ...
    <InstructorLayout>
        <div class="mb-8">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">
                Courses you're teaching and their batches
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
                ...
                <div class="mt-5 border-t pt-4">
                    ...
                    <div v-if="course.batches && course.batches.length">
                        <div
                            v-for="batch in course.batches"
                            :key="batch.id"
                            class="mb-3 px-3 py-2 rounded-md bg-gray-50 dark:bg-gray-700 text-sm"
                        >
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <div
                                        class="text-gray-400 dark:text-gray-400 text-xs"
                                    >
                                        {{ batch.time }}
                                    </div>
                                </div>
