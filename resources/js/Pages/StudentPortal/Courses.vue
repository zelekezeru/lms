    ...
    <div class="max-w-7xl mx-auto py-10 px-4 space-y-10">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 mt-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div  v-for="curriculum in student.activeCurricula" class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white"><AcademicCapIcon class="h-6 w-6 text-blue-500 mb-2" />{{ curriculum.course.name }} ({{ curriculum.course.code }})</h3>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 mt-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white">Computer Fundamentals</h3>
            <div class="flex justify-between mt-2 text-sm">
              <span class="text-gray-600 dark:text-gray-400">Completed: Jan 2025</span>
              <span class="text-gray-800 dark:text-white font-medium">Grade: A</span>
            </div>
          </div>
          <div class="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg shadow">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white">Mathematics for CS</h3>
            <div class="flex justify-between mt-2 text-sm">
              <span class="text-gray-600 dark:text-gray-400">Completed: Feb 2025</span>
              <span class="text-gray-800 dark:text-white font-medium">Grade: B+</span>
            </div>
          </div>
        </div>
      </div>
