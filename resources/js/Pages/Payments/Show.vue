...
const deletePaymentSchedule = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            router.delete(
                route("students.payment-schedules.destroy", {
                ...
                >
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <div>
                            ...
                            <button
                                @click="deletePaymentSchedule(schedule.id)"
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-2">
                        Total Expected: {{ schedule.total_expected_amount }}
                    </p>
                    ...
                    <div v-if="schedule.items && schedule.items.length > 0">
                        <ul class="list-disc pl-5">
                            ...
                            >
                                ...
                                Expected: {{ item.expected_amount }} - Paid:
                    ...
                    <div v-else class="text-gray-500 dark:text-gray-500">
                        No installments defined for this schedule.
                    </div>
                </div>
            </div>
            <div v-else class="mb-6 text-gray-500 dark:text-gray-500">
                No payment schedules found for this student.
            </div>
