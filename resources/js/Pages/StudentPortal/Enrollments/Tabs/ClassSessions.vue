...
const getStatusStyles = (status) => {
    ...
    if (s.includes("completed") || s.includes("done") || s.includes("present")) {
        return "bg-green-50 text-green-700 dark:bg-green-950/40 dark:text-green-300 border border-green-100/50 dark:border-green-900/30";
    }
    if (s.includes("cancel")) {
        return "bg-red-50 text-red-700 dark:bg-red-950/40 dark:text-red-300 border border-red-100/50 dark:border-red-900/30";
    }
    if (s.includes("progress") || s.includes("ongoing") || s.includes("active")) {
        return "bg-amber-50 text-amber-700 dark:bg-amber-950/40 dark:text-amber-300 border border-amber-100/50 dark:border-amber-900/30";
    }
    return "bg-indigo-50 text-indigo-700 dark:bg-indigo-950/40 dark:text-indigo-300 border border-indigo-100/50 dark:border-indigo-900/30";
};
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-gray-150/40 dark:border-gray-700/30 pb-6">
            <div class="space-y-1.5">
                ...
                <p class="text-xs text-gray-400 font-light">
                    Sessions log for {{ activeSemester.year.name }} Semester - Level {{ activeSemester.level }}
                </p>
            </div>
                ...
                >
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400 font-light mt-0.5">{{ enrollment.course.name }}</p>
                        </div>
                    </div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <span class="text-sm font-bold text-gray-800 dark:text-gray-250 block">
                                                {{ selectedSession.instructor?.name || (enrollment.instructor ? enrollment.instructor.name : "TBA") }}
                                            </span>
                ...
                <div v-else>
                    ...
                    <div v-if="viewMode === 'table'" class="space-y-4">
                        ...
                        <div v-else class="bg-white/70 dark:bg-gray-800/70 backdrop-blur-md p-12 text-center rounded-3xl border border-white/20 dark:border-gray-700/50 shadow-sm text-gray-400">
                            📅 No class sessions recorded for this course.
                        </div>
                    </div>
                            ...
                            >
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex justify-between items-start gap-2">
                                        <h3 class="text-sm font-black text-gray-900 dark:text-white leading-snug group-hover:text-indigo-550 dark:group-hover:text-indigo-400 transition">
                                            {{ session.date }}
                                        </h3>
                                    ...
                                    <div class="space-y-2 text-xs text-gray-650 dark:text-gray-350">
                                        ...
                                        <div v-if="session.type" class="flex items-center gap-2">
                                            <TagIcon class="w-4 h-4 text-indigo-550" />
