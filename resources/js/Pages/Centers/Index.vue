    ...
    <AppLayout>
        ...
        <div class="overflow-x-auto shadow-md sm:rounded-lg">
                    ...
                    >
                        ...
                        <td class="px-6 py-4">
                            {{
                                index +
                                1 +
                                (centers.meta.current_page - 1) *
                                    centers.meta.per_page
                            }}
                        </td>
                        <!-- Center Name -->
                        <td
                        ...
                        >
                            <Link
                                v-if="center.id"
                                :href="
                                    route('centers.show', { center: center.id })
                                "
                        ...
                        <td class="px-6 py-4 text-gray-800 dark:text-gray-100">
                            {{
                                center.coordinator && center.coordinator.user
                                    ? center.coordinator.user.name
                                    : $t("centers.noCoordinator")
                            }}
                        </td>
            ...
            <div class="mt-3 flex justify-center space-x-6">
                <Link
                    v-for="link in centers.meta.links"
                    :key="link.label"
