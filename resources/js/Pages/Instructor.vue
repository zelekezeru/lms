  ...
  <InstructorLayout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div class="col-span-3 space-y-8">
        ...
        <!-- Schedule Overview -->
        <section>
          <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-4">Weekly Teaching Schedule</h2>
          <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <ul class="space-y-2">
              <li class="flex justify-between text-sm">
                <span class="text-gray-600 dark:text-gray-300">Mon 10am - CS101</span>
                <span class="text-gray-500 dark:text-gray-400">Room 204</span>
              </li>
              <li class="flex justify-between text-sm">
                <span class="text-gray-600 dark:text-gray-300">Wed 2pm - Math201</span>
                <span class="text-gray-500 dark:text-gray-400">Room 101</span>
              </li>
              <li class="flex justify-between text-sm">
                <span class="text-gray-600 dark:text-gray-300">Fri 11am - Physics303</span>
                <span class="text-gray-500 dark:text-gray-400">Room 303</span>
              </li>
            </ul>
          </div>
        </section>
