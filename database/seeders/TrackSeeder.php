...
class TrackSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('tracks')->insert([
            ...
            [
                'id' => 14,
                'name' => 'Amharic Distance Advanced Diploma Track',
                'code' => 'DP/014/25',
                'description' => 'Amharic Distance Advanced Diploma Track',
                'program_id' => 9,
                'duration' => 4,
                'created_at' => '2025-04-11 09:18:00',
                'updated_at' => '2025-04-11 09:18:00',
            ],
            [
                'id' => 15,
                'name' => 'Distance Diploma Amharic Track',
                'code' => 'DP/015/25',
                'description' => 'Distance Diploma Amharic Track',
                'program_id' => 10,
                'duration' => 4,
                'created_at' => '2025-04-11 09:18:30',
                'updated_at' => '2025-04-11 09:18:30',
            ],
            [
                'id' => 16,
                'name' => 'Distance Degree Amharic Track',
                'code' => 'DP/016/25',
                'description' => 'Distance Degree Amharic Track',
                'program_id' => 11,
                'duration' => 4,
                'created_at' => '2025-04-11 09:19:00',
                'updated_at' => '2025-04-11 09:19:00',
            ],
            [
                'id' => 17,
                'name' => 'Online Masters Amharic Track',
                'code' => 'DP/017/25',
                'description' => 'Online Masters Amharic Track',
                'program_id' => 12,
                'duration' => 4,
                'created_at' => '2025-04-11 09:19:30',
                'updated_at' => '2025-04-11 09:19:30',
            ],
            [
                'id' => 18,
                'name' => 'Online Masters English Track',
                'code' => 'DP/018/25',
                'description' => 'Online Masters English Track',
                'program_id' => 13,
                'duration' => 4,
