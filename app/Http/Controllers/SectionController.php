...
class SectionController extends Controller
{
    ...
    {
        $section = new SectionResource($section->load(['user', 'program', 'track', 'year', 'semester', 'studyMode', 'students', 'grades', 'courseSectionAssignments.course', 'courseSectionAssignments.instructor', 'classSchedules.course', 'classSchedules.semester']));
