                        ...
                        >
                            ...
                            <tbody>
                                <tr v-for="(payment, index) in payments"
                                    ...
                                    >
                                        {{ payment.payment_method.bank_name }}
                                    </td>
                                    <td
                                        class="w-20 px-4 py-2 text-sm text-gray-600 dark:text-gray-300 border-r border-gray-300 dark:border-gray-600"
                                    >
        ...
        <div class="w-full px-8 py-6">
            ...
            <form @submit.prevent="submitNewPayment">
                <div class="mb-4">
                    ...
                    <select v-model="paymentCreationForm.payment_method_id" id="payment_method_id" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <InputError :message="paymentCreationForm.errors.payment_method_id" class="mt-2 text-sm text-red-500" />
                </div>

                <div class="mb-4">
                    <label for="payment_category_id" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Payment Category</label>
                ...
                <div class="mb-4">
                    <label for="narration" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Payment Naration</label>
                    <input type="text" v-model="paymentCreationForm.narration" id="narration" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline" />
                    <InputError :message="paymentCreationForm.errors.narration" class="mt-2 text-sm text-red-500" />
                </div>                
